      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center mb-8">
          <div className="flex items-center mb-6 md:mb-0">
           ...
           <a href="https://himovies-us.netlify.app" className="text-2xl font-bold text-white hover:text-red-600">Himovies</a>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-center md:text-left mb-4 md:mb-0">
            <p className="text-sm">&copy; {year} Himovies. All rights reserved.</p>
        ...
        <div className="mt-8 pt-6 border-t border-gray-800 text-center">
          ...
          <p className="text-xs text-gray-500 mt-2">
            Disclaimer: Himovies does not host any videos or content on its server. All content is provided by non-affiliated third parties.
          </p>
