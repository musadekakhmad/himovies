...
export const metadata = {
  title: 'Himovies: Your Hub for Free Movies, Shows & Web Series Downloads',
  description: 'Himovies is your ultimate destination. Enjoy unlimited access to thousands of movies, TV shows, and web series, all available for free download in excellent quality. ',
  openGraph: {
    title: 'Himovies: Your Hub for Free Movies, Shows & Web Series Downloads',
    description: 'Himovies is your ultimate destination. Enjoy unlimited access to thousands of movies, TV shows, and web series, all available for free download in excellent quality. ',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Himovies - Your Hub for Free Movies, Shows & Web Series Downloads',
      },
    ],
    locale: 'id_ID',
    type: 'website',
